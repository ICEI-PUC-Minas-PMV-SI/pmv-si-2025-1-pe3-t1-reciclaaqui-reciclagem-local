...
export { default as Perfil } from './pages/Perfil/Perfil';
export { default as Home } from './pages/Home/Home';
export { default as GuiaReciclagem } from './pages/GuiaReciclagem/GuiaReciclagem';
...
export { default as CadastrarPonto } from './pages/PontosDeColeta/CadastrarPonto';
